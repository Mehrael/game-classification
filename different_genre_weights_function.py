...
# from mlxtend.plotting import plot_decision_regions
# #
# plot_decision_regions(x_train.values, y_train.values, clf=model, legend=2 ,filler_feature_values={2: 0.5, 3: 0.5, 4: 0.5, 5: 0.5, 6: 0.5, 7: 0.5, 8: 0.5, 9: 0.5, 10: 0.5},
#                             filler_feature_ranges={2: 0.5, 3: 0.5, 4: 0.5, 5: 0.5, 6: 0.5, 7: 0.5, 8: 0.5, 9: 0.5, 10: 0.5},)
# # Adding axes annotations
# plt.xlabel('X')
# plt.ylabel('Y')
# plt.title('Naive')
